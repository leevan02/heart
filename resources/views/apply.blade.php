...
<form action="{{ url('/applied') }}" method="post" enctype="multipart/form-data">   
  @csrf
...
<div class="container rounded bg-white mt-5 mb-5">
 ...
 id="profileImage" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"
 />
...
@endforeach --}}
          ...
          <div class="p-3 py-5">
              ...
              <div class="row mt-2">
                  ...
                  <div class="col-md-6">
                    ...
                    value="{{ old('lname') }}" name="lname" placeholder="surname">
                  </div>
              </div>
              ...
              <div class="row mt-3">
                  ...
                  <div class="col-md-12"><label class="labels">Email</label>
                    <input type="emailt" class="form-control" placeholder="enter your email"
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" placeholder="enter address line 2" 
                      name="address5" value="{{ old('address5') }}">
                  </div>
      ...
      <div class="col-md-4">
          ...
          <div class="custom-file">
            ...
            <input type="file" class="custom-file-input" id="customFile" name="qualification">
            ...
            <div class="form-row mt-2">
              <div class="form-group col-md-6">
                ...
                <input type="text" name="school"  value="{{ old('school') }}" class="form-control" id="inputCity">
              </div>
              <div class="form-group col-md-4">
                <label for="inputState">Certificate</label>
                     <input type="text" name="certi"  value="{{ old('certi') }}" class="form-control" id="inputCity">
          
              </div>
              <div class="form-group col-md-2">
                <label for="inputZip">Year</label>
                <input type="text" name="year" class="form-control" value="{{ old('year') }}" id="inputZip">
              </div>
            </div>
            ...
            <div class="row ">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control"
                 name="price" value="{{ $data->course->price }}" placeholder="$ price">
                </div>
             @endforeach
          </div>
              <div class="wrapper">
                <h4 class="text-uppercase">Payment Details</h4>
                    ...
                    <div class="form-group"> 
                      <label for="card_holder" class="text-uppercase">name on the card</label>
                       ...
                       {{ old('card_holder') }} placeholder="Nicolos Flemming">
                       </div>
                    <div class="form-group"> 
                      <label for="card" class="text-uppercase">card number</label>
                        <div class="card-number"> 
                          <input type="text" name="card" class="card-no" step="4"
                          {{ old('expire') }} placeholder="1234 4567 5869 1234" pattern="^[0-9].{15,}"> <span class="">
                        ...
                        <div class="d-flex w-50 pr-sm-4">
                            <div class="form-group"> 
                              <label for="expiry" class="text-uppercase">exp.date</label>
                               <input type="text" class="form-control" {{ old('expire') }}
                                 name="expire" placeholder="03/2020"> 
                              </div>
                        </div>
                            ...
                            <div class="form-group"> 
                              <label for="cvv">CVV</label> 
                               ...
                               <input type="password" class="form-control pr-5" maxlength="3"
                                name="cvc" {{ old('cvc') }} placeholder="123"> 
                              </div>
                        </div>
                    </div>
